const artists = [
  ...
  // iterate over the array of artists and print the artist name to the console
...
let filtered_artists = artists.filter(function(artists){
  return artists.name == "David Hammons" 
})
